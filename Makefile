...
ifeq ($(VERSION),jp)
#ifeq ($(LANGUAGE),en)
TEXT_DIRS := text/us text/jp
$(BUILD_DIR)/bin/segment2.o: $(BUILD_DIR)/text/us/define_text.inc.c
$(BUILD_DIR)/bin/segment2.o: $(BUILD_DIR)/text/us/define_courses.inc.c
#else
$(BUILD_DIR)/bin/segment2.o: $(BUILD_DIR)/text/jp/define_text.inc.c
$(BUILD_DIR)/bin/segment2.o: $(BUILD_DIR)/text/jp/define_courses.inc.c
#endif
endif
